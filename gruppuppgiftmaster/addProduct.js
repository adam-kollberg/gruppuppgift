...
// Create Remove button on Product Card
const createRemoveBtn = document.createElement("button");
createdDiv.appendChild(createRemoveBtn);
createRemoveBtn.innerText= "Remove";
    ...
    const btn_remove_product = document.querySelector(".?????????")
